package gmaths;
//Code form supplied exercises with an added function noted by comments 
...
public class Mat4 {   // row column formulation
  ...
  public static Vec4 multiply(Mat4 a, Vec4 b) {
    ...
    result.x = b.x*a.values[0][0]+ b.y*a.values[0][1]+b.z*a.values[0][2]+b.w*a.values[0][3];
    result.y = b.x*a.values[1][0]+ b.y*a.values[1][1]+b.z*a.values[1][2]+b.w*a.values[1][3];
    result.z = b.x*a.values[2][0]+ b.y*a.values[2][1]+b.z*a.values[2][2]+b.w*a.values[2][3];
    result.w = b.x*a.values[3][0]+ b.y*a.values[3][1]+b.z*a.values[3][2]+b.w*a.values[3][3];
    return result;
  }
  //End of own code
