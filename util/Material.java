 ...
 */
// code form supplied exercises Own code marked with comments
...
public class Material {
    ...
    // Own code
    public static Material multiply(Material m, float value) {
        return new Material(Vec3.multiply(m.ambient, value), Vec3.multiply(m.diffuse, value),
                Vec3.multiply(m.specular, value), m.shininess);
    }
    // End of own code
